...
/* ==========================================================================
   ...
   ========================================================================== */
export const UserInputPanel = ({ isStreaming, onSendMessage, placeholder }) => {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder={isStreaming ? 'RX IN PROGRESS...' : (placeholder || '向忒修斯发送指令...')}
      ...
      <button
        ...
        <span style={{ display: 'inline-block', transform: 'skewX(8deg)' }}>EXEC</span>
      </button>
    </form>
  );
};
